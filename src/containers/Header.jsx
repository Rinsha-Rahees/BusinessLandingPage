  ...
  return (
    <div className="flex fixed justify-between items-center w-full h-fit max-w-[95vw] backdrop-blur-xl rounded-lg p-3 mt-3 z-10">
      ...
      onClick={handleMenuClick}>
        <img className="w-8" src={MENU_ICON} alt="Menu Icon" />
      </button>

      {menuOpen && <div className="absolute h-fit w-fit top-2 right-2 border-2 border-[#200e32] bg-[#f0eeeb] text-[#200e32] rounded-md pb-6 pt-2 px-5">
        ...
        >
          <img className="w-7" src={MENU_CLOSE} alt="Menu Close Icon" />
        </button>
